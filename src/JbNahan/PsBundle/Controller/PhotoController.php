...
use JbNahan\PsBundle\Entity\Photo;
use JbNahan\PsBundle\Form\PhotoType;
...
class PhotoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('JbNahanPsBundle:Photo')->findAll();
     ...
     * @Method("POST")
     * @Template("JbNahanPsBundle:Photo:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('JbNahanPsBundle:Photo')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("JbNahanPsBundle:Photo:edit.html.twig")
     */
