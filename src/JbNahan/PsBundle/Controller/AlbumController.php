...
use JbNahan\PsBundle\Entity\Album;
use JbNahan\PsBundle\Form\AlbumType;
...
class AlbumController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('JbNahanPsBundle:Album')->findAll();
     ...
     * @Method("POST")
     * @Template("JbNahanPsBundle:Album:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('JbNahanPsBundle:Album')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("JbNahanPsBundle:Album:edit.html.twig")
     */
